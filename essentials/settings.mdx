...
<ResponseField name="favicon" type="string">
  Path to the favicon image (for example, `/favicon.png`). Ensure the file exists at that path in your static assets (the repository does not include the favicon file).
</ResponseField>
